...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('land_assets/css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Material Design Bootstrap -->
    <link href="{{ asset('land_assets/css/mdb.min.css') }}" rel="stylesheet">
    <style type="text/css">
        html,
        body,
        header,
                ...
                <div class="row flex-center pt-5 mt-3">
                    <div class="col-md-12 col-lg-6 text-center text-md-left margins">
                        <div class="white-text">
                            ...
                            <br>
                            <a class="btn btn-white btn-rounded blue-text font-weight-bold ml-lg-0 wow fadeInLeft" data-wow-delay="0.3s">Download</a>
...
<main>
    ...
    <div class="container">
        ...
        <section id="features" class="section feature-box mb-5">
            ...
            <!--Section heading-->
            <h1 class="mb-3 my-5 pt-5 dark-grey-text wow fadeIn text-center" data-wow-delay="0.2s"><strong class="font-weight-bold">Lorem ipsum</strong> dolor sit amet</h1>
            ...
            <section>
                ...
                <div class="row my-4 pt-5 wow fadeIn" data-wow-delay="0.4s">
                    ...
                    <div class="col-lg-5 col-md-12 mb-4 text-left">
                        ...
                        <!--Section heading-->
                        <h2 class="mb-3 my-5 dark-grey-text wow fadeIn" data-wow-delay="0.2s"><strong class="font-weight-bold">Download</strong> the application</h2>
                        ...
                        <a class="btn btn-white btn-rounded blue-text font-weight-bold ml-0 wow fadeIn" data-wow-delay="0.2s"><i class="fab fa-android pr-2" aria-hidden="true"></i> Play store</a>
                        <a class="btn btn-white btn-rounded blue-text font-weight-bold wow fadeIn" data-wow-delay="0.2s"><i class="fab fa-apple pr-2" aria-hidden="true"></i> App store</a>
                    </div>
                    <!-- /.Second column -->
        ...
        <div class="flex-center white-text blue-gradient-mask">
            <div class="container py-3">
                ...
                <section class="section feature-box wow fadeIn" data-wow-delay="0.2s">
                    ...
                    <!--Section heading-->
                    <h1 class="py-5 my-5 white-text text-center wow fadeIn" data-wow-delay="0.2s"><strong class="font-weight-bold">Lorem ipsum</strong> dolor sit amet</h1>
                    ...
                    <div class="row features-small mb-5">
                        ...
                        <div class="col-md-12 col-lg-4">
                            ...
                            <div class="row mb-5">
                                <div class="col-3">
                                    <a type="button" class="btn-floating white btn-lg my-0"><i class="fas fa-tablet-alt blue-text" aria-hidden="true"></i></a>
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row mb-5">
                                <div class="col-3">
                                    <a type="button" class="btn-floating white btn-lg my-0"><i class="fas fa-level-up-alt blue-text" aria-hidden="true"></i></a>
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row mb-5">
                                <div class="col-3">
                                    <a type="button" class="btn-floating white btn-lg my-0"><i class="fas fa-phone blue-text" aria-hidden="true"></i></a>
                                </div>
                                <div class="col-9">
                        ...
                        <div class="col-md-12 col-lg-4">
                            ...
                            <div class="row mb-5">
                                <div class="col-3">
                                    <a type="button" class="btn-floating white btn-lg my-0"><i class="far fa-object-group blue-text" aria-hidden="true"></i></a>
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row mb-5">
                                <div class="col-3">
                                    <a type="button" class="btn-floating white btn-lg my-0"><i class="fas fa-rocket blue-text" aria-hidden="true"></i></a>
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row mb-5">
                                <div class="col-3">
                                    <a type="button" class="btn-floating white btn-lg my-0"><i class="fas fa-cloud-upload-alt blue-text" aria-hidden="true"></i></a>
                                </div>
                                <div class="col-9">
    ...
    <div class="container">
        ...
        <section class="section mt-4 mb-5">
            ...
            <!--Section heading-->
            <h1 class="mb-3 my-5 pt-5 text-center dark-grey-text wow fadeIn" data-wow-delay="0.2s"><strong class="font-weight-bold">Lorem ipsum</strong> dolor sit amet</h1>
        ...
        <section class="section text-center pb-4">
            ...
            <!--Section heading-->
            <h1 class="mb-5 my-5 pt-5 text-center dark-grey-text wow fadeIn" data-wow-delay="0.2s"><strong class="font-weight-bold">Our clients</strong> about us</h1>
...
<!-- JQuery -->
<script type="text/javascript" src="{{ asset('land_assets/js/jquery-3.3.1.min.js') }}"></script>

<!-- Bootstrap tooltips -->
<script type="text/javascript" src="{{ asset('land_assets/js/popper.min.js') }}"></script>

<!-- Bootstrap core JavaScript -->
<script type="text/javascript" src="{{ asset('land_assets/js/bootstrap.min.js') }}"></script>

<!-- MDB core JavaScript -->
<script type="text/javascript" src="{{ asset('land_assets/js/mdb.min.js') }}"></script>
